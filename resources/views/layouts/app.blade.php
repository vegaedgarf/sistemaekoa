...
<head>
    ...
    <title>@yield('title', 'Inicio') | Proyecto EKOA Clone</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#nosotros">El Proyecto</a></li>
                    <li class="nav-item"><a class="nav-link" href="#impacto">Impacto Ambiental</a></li>
